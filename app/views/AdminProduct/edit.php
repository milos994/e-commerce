            ...
            <div class="col-12 col-md-8 col-lg-6 mb-5">
                <div class="border rounded p-4">
                    <form method="post" action="<?php echo Configuration::BASE_URL; ?>admin/proizvodi/edit/<?php echo htmlspecialchars($DATA['proizvod']->product_id);?>">
                        ...
                        <input class="form-control pl-3" type="text" name="name" id="name" required value="<?php echo htmlspecialchars($DATA['proizvod']->name);?>"><br>

                        <label for="short_text" class="pl-3">Kratak opis: </label>
                        <input class="form-control pl-3" type="text" name="short_text" id="short_text" value="<?php echo htmlspecialchars($DATA['proizvod']->short_text);?>"><br>

                        <label for="long_text" class="pl-3">Detaljan opis: </label>
                        <textarea class="form-control pl-3" rows="9" type="text" name="long_text" id="long_text"><?php echo htmlspecialchars($DATA['proizvod']->long_text);?></textarea><br>

                        <label for="cena" class="pl-3">Cena: </label>
                        <input class="form-control pl-3" type="number" name="amount" id="cena" value="<?php echo htmlspecialchars($DATA['proizvod']->amount);?>"><br>
